...
public class RayTestSimpleParser {
...
*/
	...
	@Test
	public void def_key_value_type7() throws SyntaxException {
		System.out.println("def_key_value_type7");
		String input = "class A {def S:@@[:int];} ";
		System.out.println(input);
	...
	@Test
	public void def_key_value_type8() throws SyntaxException {
		System.out.println("def_key_value_type8");
		String input = "class A {def S:@@[int:];} ";
		System.out.println(input);
		parseIncorrectInput(input, RSQUARE);
	}	
